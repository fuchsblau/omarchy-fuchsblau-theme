/**
 * GTK3/GTK4 Adwaita overrides, generated per theme from colors.toml.
 * User template: ~/.config/omarchy/themed/gtk.css.tpl
 * ~/.config/gtk-3.0/gtk.css and ~/.config/gtk-4.0/gtk.css are symlinks
 * to the generated ~/.local/state/omarchy/current/theme/gtk.css.
 * Structure inherited from the former static "Aether Sharp Corners" file;
 * palette now token-driven so Files & friends follow every theme.
 */
...
@define-color bright_white {{ light_foreground }};
